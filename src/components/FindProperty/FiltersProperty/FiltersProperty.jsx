...
const dropDownList = ({input, data, valueField, textField}) =>
    <DropdownList {...input}
                  onBlur={()=> input.onBlur()}
            ...
            <div className={classes.filters}>
                ...
                <div className={classes.overflowAuto}>
                    ...
                    <div style={{width:"200px"}}>
                        <label>
                            <div style={{marginBottom:"5px"}} className={classes.labelTitle}>Сартировка по дате</div>
                        </label>
                        <Field
                            name="dataSort"
                            component={dropDownList}
                            data={[{text:'За день', value:1}, {text:'За неделю', value:7}, {text:'За месяц', value:31}, {text:'За полгода', value:183}]}
                        />
                    </div>
                    <div>
                        <label>
                            <div className={classes.labelTitle}>Описание объявления</div>
                        </label>
                        <Field
                            name="description"
                            component={InputForFilters}
