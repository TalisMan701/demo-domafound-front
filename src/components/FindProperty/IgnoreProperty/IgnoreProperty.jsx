...
import classes from "./IgnoreProperty.module.css";
import closeIcon from "./close.svg";

const IgnoreProperty = (props) => {
    return (
        <div className={classes.property}>
            ...
            <div className={classes.content}>
                ...
                <div className={classes.btns}>
                    <div onClick={() => {props.removeToIgnoreList(props.item.id)}} className={`${classes.btnAddToFavorites} ${classes.btn}`}>Убрать из игнора</div>
